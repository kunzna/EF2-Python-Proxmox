...
class ProxmoxExtension(Extension):  # Enable for testing with DT Extensions SDK
    ...
    def initialize(self, **kwargs):
        ...
        for endpoint in endpoints:
            ...
            # use_vault = endpoint.get("use_credential_vault", False)
            # user_key = "username" if use_vault else "user"
            user_key = "user"
        ...
        for node in node_info_list:
            ...
            node_dimensions = {
                **parent_dimensions,
                ...
                "nodeip": node_ip,
                "nodeid": node_id,
                "nodecores": cpuinfo_cores,
                "nodesockets": cpuinfo_sockets
            }
